					...
					<div class="banner-container" :style="style">
						...
						<div class="title">
							...
							<div class="bottom">
								...
								<span v-if="user.isAdmin" :title="i18n.ts.administrator" style="color: var(--badge);"><i class="ti ti-shield-check"></i></span>
								<span v-if="!user.isAdmin && user.isModerator" :title="i18n.ts.moderator" style="color: var(--badge);"><i class="ti ti-shield"></i></span>
