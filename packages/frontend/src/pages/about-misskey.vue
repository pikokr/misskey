			...
			<div class="_gaps_m znqjceqz">
				...
				<FormSection>
					<div class="_formLinks">
						<FormLink to="https://github.com/pikokr/misskey" external>
				...
				<FormSection>
					...
					<div :class="$style.contributors">
						...
						<a href="hffps://github.com/pikokr" target="_blank" :class="$style.contributor">
							<img src="https://avatars.githubusercontent.com/u/68010770?v=4" :class="$style.contributorAvatar">
							<span :class="$style.contributorUsername">@pikokr
